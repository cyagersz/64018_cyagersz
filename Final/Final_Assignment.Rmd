...
```{r}
# Read the LP file
x <- read.lp("Final.lp")   # Specify type if it's a minimization
...
The total cost for all employees for the week is $11300. The paramedics are $5000 of the total weekly cost and the EMT are $6300 of the cost for the week. The schedule created by the lp solution fits the maximum of 5 days a week / minimum 2 days off a week. It also meets the required days off by certain employees. The schedule also doesn't allow for a employee to work more than 4 consecutive days. The schedule also makes sure that the required amount of total employees and paramedics are there for the required week day.
